...
const Airborne = (): JSX.Element => (
  <svg id="icon-aircraft-circle" viewBox="0 0 40 40">
    <circle style={{ fill: '#fff' }} cx="20" cy="20" r="19.8" />
    <path
      style={{ fill: '#f8c024' }}
      d="M33.5,22.5c-1.9,0.1-6.7-0.1-6.7-0.1s-8.2,11.6-9.5,11.5c-1.2-0.1-2.6-0.4-2.6-0.4s6-11.4,4.5-11.3
